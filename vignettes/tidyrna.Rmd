---
title: "Getting Started with TidyRNA"
author: "Your Name"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with TidyRNA}
...
TidyRNA is designed to make RNA-Seq analysis accessible to researchers with limited programming experience. This vignette demonstrates how to perform a complete RNA-Seq analysis workflow from data import to visualization and reporting.

## Installation

You can install TidyRNA from GitHub:
...
```{r save_results}
# Save TidyRNA object for later use
save_analysis(rnaseq, "results/tidyrna_results.rds")

# Load saved results
reloaded_rnaseq <- load_analysis("results/tidyrna_results.rds")
```

## Customizing Parameters

TidyRNA provides sensible defaults for all parameters, but you can customize each step according to your needs.
...
TidyRNA simplifies RNA-Seq analysis for researchers with limited programming experience while maintaining analytical rigor. By providing informative error messages, extensive validation, and intuitive visualizations, the package reduces technical barriers to RNA-Seq analysis while ensuring reproducibility.
